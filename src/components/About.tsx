...
const About: React.FC = () => {
  ...
  return (
    <section id="about" className="py-10 relative overflow-hidden bg-black">
      {/* Background Elements */}
      <div className="absolute inset-0">
        <div className="absolute top-1/3 left-0 w-96 h-96 bg-gold/10 rounded-full blur-3xl"></div>
